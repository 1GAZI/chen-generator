...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "chen");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.chen");
